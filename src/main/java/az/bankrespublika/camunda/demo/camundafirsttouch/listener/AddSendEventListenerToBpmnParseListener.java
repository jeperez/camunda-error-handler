 ...
 *
 * az.bankrespublika.camunda.demo.camundafirsttouch.listener.AddSendEventListenerToBpmnParseListener
 *
...
public class AddSendEventListenerToBpmnParseListener implements BpmnParseListener {
    ...
    public void parseProcess(Element processElement, ProcessDefinitionEntity processDefinition) {
        System.err.println("parseProcess");
    ...
    public void parseStartEvent(Element startEventElement, ScopeImpl scope, ActivityImpl startEventActivity) {
        System.err.println("parseStartEvent");
    }
